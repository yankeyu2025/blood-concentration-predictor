...
def load_model():
    ...
    try:
        ...
        possible_paths = [
            ...
            os.path.join(project_root, 'web_models', 'svm_model.pkl'),
            os.path.join(os.getcwd(), 'web_models', 'svm_model.pkl'),
        ...
        # Load scaler
        scaler_path = model_path.replace('svm_model.pkl', 'svm_scaler.pkl')
        with open(scaler_path, 'rb') as f:
            scaler = pickle.load(f)
        
        # Load metadata
        metadata_path = model_path.replace('svm_model.pkl', 'model_metadata.json')
